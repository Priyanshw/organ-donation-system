...
def result():
    ...
    scaler_path = os.path.join(r'C:\Users\USER\OneDrive\Desktop\ML\Stroke-Risk-Prediction-using-Machine-Learning', r'models\scaler.pkl')
    scaler=None
    ...
    model_path = os.path.join(r'C:\Users\USER\OneDrive\Desktop\ML\Stroke-Risk-Prediction-using-Machine-Learning', r'models\dt.sav')
